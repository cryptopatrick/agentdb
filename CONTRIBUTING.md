...
First off, thank you for considering contributing to agentdb. 
It's people like you that make agentdb great!
...
```bash
git clone https://github.com/cryptopatrick/agentdb.git
cd agentdb
```
...
To run agentdb, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/agentdb/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/agentdb/issues) to report any bugs or request new features.
